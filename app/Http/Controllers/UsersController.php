...
//            'postal' => 'required',
    ...
    public function getTrainerSettings() {
        $user = auth()->user();
        ...
        // dd(\DB::getQueryLog());
        return view('trainer-dashboard.trainer-account-settings', compact('user'), array('trainer' => $trainer));
    }
    ...
    public function saveTrainerSettings(Request $request) {
        $this->validate($request, [
            'name' => 'required',
        ...
        $update_trainer->save();
        Session::flash('message', 'Your information has been updated');
        Session::flash('message', 'Account has been updated');
        return redirect()->back();
    }
