...
<style>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Edit Customer</h3>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="form-group {{ $errors->first('customer_name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_name"  name="customer_name"     class="form-control required" 
                                                   placeholder="Customer Name..." value="{!! old('customer_name', $customer->name) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_email', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="email" class="form-control"  id="customer_email"  name="customer_email"     class="form-control required" 
                                                   placeholder="Customer Email..." value="{!! old('customer_email',$customer->email) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_post_code', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_post_code"  name="customer_post_code"     class="form-control required" 
                                                   placeholder="Customer Post Code..." value="{!! old('customer_post_code',$customer->post_code) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_landline', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_landline"  name="customer_landline"     class="form-control required" 
                                                   placeholder="Customer Land Line..." value="{!! old('customer_landline',$customer->landline) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_mobile', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_mobile"  name="customer_mobile"     class="form-control required" 
                                                   placeholder="Customer Mobile..." value="{!! old('customer_mobile',$customer->mobile) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_fax', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_fax"  name="customer_fax"     class="form-control required" 
                                                   placeholder="Customer Fax..." value="{!! old('customer_fax',$customer->fax) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_website', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_website"  name="customer_website"     class="form-control required" 
                                                   placeholder="Customer Website..." value="{!! old('customer_website',$customer->website) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('direct_number', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('direct_number',$customer->direct_number) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('direct_email', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   value="{!! old('direct_email',$customer->direct_email) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('contact_mobile', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('contact_mobile',$customer->contact_mobile) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('account_manager_name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('account_manager_name',$customer->account_manager_name) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('manager_contact_number', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('manager_contact_number',$customer->manager_contact_number) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('manager_email', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   value="{!! old('manager_email',$customer->manager_email) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('venue_id', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="venue_id">
                                                ...
                                                <option value="{{$venue->id}}" @if(old('venue_id')===$venue->id||$customer->venue_id) selected @endif>{{$venue->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group {{ $errors->first('venue_contact_name', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('venue_contact_name',$customer->venue_contact_name) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('venue_contact_email', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="email" 
                                                   ...
                                                   value="{!! old('venue_contact_email',$customer->venue_contact_email) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('venue_contact_number', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('venue_contact_number',$customer->venue_contact_number) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('venue_contact_address', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{!! old('venue_contact_address',$customer->venue_contact_address) !!}"/> 
                                ...
                                <div class="tab-pane" id="tab5">
                                    ...
                                    <div class="form-group {{ $errors->first('customer_discount', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="number" min="0" max="100" class="form-control"  id="customer_discount" name="customer_discount"  
                                                   placeholder="Customer Discount Rate..." value="{!! old('customer_discount',$customer->discount_rate) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_work_package', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" class="form-control"  id="customer_work_package" name="customer_work_package" 
                                                   placeholder="Customer Work Package..." value="{!! old('customer_work_package',$customer->work_package_number) !!}"/> 
                                    ...
                                    <div class="form-group {{ $errors->first('customer_status', 'has-error') }}">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" title="Select Customer Status..." name="customer_status">
                                                ...
                                                <option 
                                                    value="1"
                                                    @if(old('customer_status') === "1" || $customer->status === "1") selected @endif >Active
                                            </option>
                                            <option 
                                                value="0"
                                                @if(old('customer_status') === "0" || $customer->status === "0") selected @endif >Non Active
                                        </option>
                                    </select>
                                </div>
                                <span class="help-block">{{ $errors->first('customer_status', ':message') }}</span>
                            </div>   <div class="form-group {{ $errors->first('client_type', 'has-error') }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" title="Select Customer Status..." name="client_type">
                                        ...
                                        <option 
                                            value="1"
                                            @if(old('client_type') === "1" || $customer->client_type=== "1") selected="selected" @endif >Active
                                    </option>
                                    <option 
                                        value="0"
                                        @if(old('client_type') === "0"|| $customer->client_type=== "0") selected="selected" @endif >Non Active
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="radio-list">
                            <label class="radio-inline p-0">
                                <div class="radio radio-info">
                                    <input type="radio" name="customer_marketing_opt" id="customer_marketing_opt" value="yes" required="" @if(old('customer_marketing_opt') === "yes"|| $customer->marketing_opt === "yes") checked="checked" @endif >
                                           <label for="radio1">Yes</label>
                                </div>
                            </label>
                            <label class="radio-inline">
                                <div class="radio radio-info">
                                    <input type="radio" name="customer_marketing_opt" id="customer_marketing_opt" value="no" @if(old('customer_marketing_opt') === "no"|| $customer->marketing_opt === "no") checked="checked" @endif>
                    ...
                    <div class="form-group {{ $errors->first('contact_method', 'has-error') }}">
                        ...
                        <div class="radio-list">
                            <label class="radio-inline">
                                <div class="radio radio-info">
                                    <input type="radio" name="contact_method" id="" value="email" @if(old('contact_method') === "email"|| $customer->contact_method=== "email") checked="checked" @endif>
                                           <label for="radio2">Email </label>
                                </div>
                            </label>
                            <label class="radio-inline p-0">
                                <div class="radio radio-info">
                                    <input type="radio" name="contact_method" id="" value="letter" @if(old('contact_method') === "letter"|| $customer->contact_method=== "letter") checked="checked" @endif>
                            ...
                            <label class="radio-inline">
                                <div class="radio radio-info">
                                    <input type="radio" name="contact_method" id="" value="sms" @if(old('contact_method') === "sms"|| $customer->contact_method=== "sms") checked="checked" @endif>
                                           <label for="radio2">SMS </label>
                                </div>
                            </label>
                            <label class="radio-inline">
                                <div class="radio radio-info">
                                    <input type="radio" name="contact_method" id="" value="phone" @if(old('contact_method') === "phone"|| $customer->contact_method=== "phone") checked="checked" @endif>
