...
<div class="container-fluid">
                            ...
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="form-group {{ $errors->first('customer_name', 'has-error') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2 text-capitalize" id="customer_name" name="customer_name" onchange="get_customer()">
                                            ...
                                            <option value="{{$customer->id}}" @if(old('customer_name')===$customer->id) selected @endif>{{$customer->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="customer_info" style="display:none;">
                                    <div class="form-group  ">
                                        ...
                                        <label for="trainer" id="customer_email" class="col-sm-10"></label>
                                    </div>
                                    <div class="form-group  ">
                                        <label for="trainer"   class="col-sm-2 control-label">Customer Land Line :</label>
                                        <label for="trainer" id="customer_landline" class="col-sm-10"></label>
                                    </div>
                                    <div class="form-group  ">
                                        <label for="trainer"   class="col-sm-2 control-label">Discount Rate % :</label>
                                        <label for="trainer" id="customer_discount" class="col-sm-10"></label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group {{ $errors->first('course_type', 'has-error') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" title="Select..." name="course_type">
                                            ...
                                            <option 
                                                value="1"
                                                @if(old('course_type') === "private") selected="selected" @endif >Private
                                        </option>
                                        <option 
                                            value="0"
                                            @if(old('course_type') === "public") selected="selected" @endif >Public
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group {{ $errors->first('course_status', 'has-error') }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" title="Select  Course..." name="course_status">
                                    ...
                                    <option 
                                        value="1"
                                        @if(old('course_status') === "1") selected="selected" @endif >Active
                                </option>
                                <option 
                                    value="0"
                                    @if(old('course_status') === "0") selected="selected" @endif >Non Active
                            </option>
                        </select>
                    </div>
                    <span class="help-block">{{ $errors->first('course_type', ':message') }}</span>
                ...
                <div class="form-group {{ $errors->first('cost', 'has-error') }}">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" title="Select..." name="cost">
                            ...
                            <option 
                                value="10"
                                @if(old('cost') === "10") selected="selected" @endif >10
                        </option>
                        <option 
                            value="20"
                            @if(old('cost') === "20") selected="selected" @endif >20
                    </option>
                    <option 
                        value="0"
                        @if(old('cost') === "30") selected="selected" @endif >30
                </option>
            </select>
        </div>
    ...
    <div class="form-group {{ $errors->first('venue', 'has-error') }}">
        ...
        <div class="col-sm-10">
            <select class="form-control" name="venue" id="select_venue" onchange="get_trainer()">
                ...
                <option value="{{$venue->id}}" @if(old('venue')===$venue->id) selected @endif>{{$venue->name}}</option>
                @endforeach
            </select>
        </div>
    ...
    <div class="form-group {{ $errors->first('fees', 'has-error') }}">
        ...
        <div class="col-sm-10 hidden venue_fees"  >
            <input type="number" 
                   class="form-control"  
                   id="input_venue_fees"
                   name="fees" 
...
<ul class="pager wizard">
    <input type="hidden" name="trainer" id="get_trainer_id" >
